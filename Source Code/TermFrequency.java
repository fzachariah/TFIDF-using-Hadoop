 ...
 * @since 09/24/2017
 * @description TermFrequecny Program calculates the logarithmic Term Frequency
 *              of each word in each file and stores the result.
 *
 */
public class TermFrequency extends Configured implements Tool {
	...
	public static class Reduce extends
		...
		public void reduce(Text word, Iterable<IntWritable> counts,
			...
			if (sum > 0) {
				finalOutput = 1 + Math.log10(sum);
			}
			context.write(word, new DoubleWritable(finalOutput));
		}
	}
